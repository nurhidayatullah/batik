...
foreach($customers as $data){
	$id = $this->my_encrypt->encode($data['id_cust']);
	$nama = $data['nama_cust'];
	$alamat = $data['alamat'];
	$kota = $data['kota'];
	$telp = $data['telp'];
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="portlet box green-haze tasks-widget">
						...
						<?php } ?>
							...
							<form class="" method="post" role="form" action="<?php echo base_url('batik/customers/update/'.$id);?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="kota">Kota
									<input class="form-control" type="text" name="kota" value="<?php echo $kota;?>" required />
								</div>
								<div class="form-group">
								...
								<label for="foto">Foto
									<div class='controls'>
										<img src="<?=base_url()?>/assets/upload/cust/<?php echo $foto;?>" id="gambar" width="100px">
