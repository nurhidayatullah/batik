								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											...
											<?php if($tambah){?>
												<div class="btn-group">
													<a href="<?php echo base_url('batik/batik/new_data/'.$menu);?>" class="btn green">Add New <i class="fa fa-plus"></i></a>
												</div>
											<?php }
											 if(!empty($msg)){ 
												if($msg==0){
									...
									<table class="table table-striped table-bordered table-hover" id="tb">
										...
										<?php if(isset($batik)){
											...
											<tr>
												...
												<td>
												<?php if($edit){?>
													<a href="<?php echo base_url('batik/batik/edit/'.$menu.'/'.$this->my_encrypt->encode($data['id_batik']));?>" class="btn btn-xs purple">Edit <i class="fa fa-pencil-square-o"></i></a>&nbsp;
												<?php } 
												if($hapus){
												?>	
													<a href="<?php echo base_url('batik/batik/hapus/'.$menu.'/'.$this->my_encrypt->encode($data['id_batik']));?>" class="btn btn-xs red">Hapus <i class="fa fa-trash"></i></a></td>
												<?php } ?>
											</tr>
											<?php $i++;
											}
